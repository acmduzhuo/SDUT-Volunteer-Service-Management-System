...
<table class="layui-table" lay-data="{url:'customer_shichang_list', page:true, id:'customertable_id',toolbar:'#toolbar'}" lay-filter="customertable">
  <thead>
    <tr>
