...
<table class="layui-table" lay-data="{url:'customer_yanfa_list', page:true, id:'customertable_id',toolbar:'#toolbar'}" lay-filter="customertable">
  <thead>
    <tr>
